...
const faqs = [
  { q: "كم سعر تأجير يخت في دبي؟", a: "تتراوح الأسعار المعروضة حالياً بين 400 و5,000 درهم للساعة. راجع أيضاً الحد الأدنى للمدة، ثم اطلب السعر النهائي لليخت والموعد المحددين." },
  ...
  { q: "ما الحد الأدنى لمدة الحجز؟", a: "يعتمد على اليخت؛ الخيارات الحالية تسجل حداً أدنى من ساعتين أو ثلاث أو أربع ساعات." },
