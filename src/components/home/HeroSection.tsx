...
const HERO_DESKTOP =
  "https://dubai-yacht.fra1.cdn.digitaloceanspaces.com/dubai_yacht_luxury_dt.avif";
const HERO_MOBILE =
  "https://dubai-yacht.fra1.cdn.digitaloceanspaces.com/dubai_yacht_luxury_mob.avif";
    ...
    >
      <motion.div style={{ y: imgY }} className="absolute inset-0">
        <img
          ...
          alt="Luxury yacht rental in Dubai Marina"
