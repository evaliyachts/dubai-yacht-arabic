...
const verifiedYachtData: VerifiedYachtInput[] = [
  ...
  { id: "yacht-06", slug: "يخت-أزيموت-50-قدم-للإيجار", name: "يخت أزيموت 50 قدم للإيجار", lengthFt: 50, guestCapacity: 15, yearBuilt: 2015, pricePerHour: 650, minimumDuration: 2, numberOfBedrooms: 1, availability: "available", featured: false, priority: 6 },
  { id: "yacht-07", slug: "يخت-أوريكس-50-قدم-للإيجار", name: "يخت أوريكس 50 قدم للإيجار", lengthFt: 50, guestCapacity: 15, yearBuilt: 2018, pricePerHour: 500, minimumDuration: 2, numberOfBedrooms: 1, availability: "available", featured: false, priority: 6 },
  { id: "yacht-08", slug: "يخت-فيريتي-50-قدم-للإيجار", name: "يخت فيريتي 50 قدم للإيجار", lengthFt: 50, guestCapacity: 12, yearBuilt: 2018, pricePerHour: 1000, minimumDuration: 2, numberOfBedrooms: 3, availability: "available", featured: false, priority: 6 },
